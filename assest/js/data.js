...
//
//
//var age= users.map(e => e.age ,e => e.lastName)
//var lastName = users.map(e => e.lastName);
//var email =users.map(e =>e.email);
//console.log(email);
...
// return e.age>30;
//}
//console.log(users.filter(checkAge));

//const age = prompt("what is your age");
//console.log(typeof age);
//const  check=(e)=>{
//console.log(typeof e.age);
//return e.age === Number(age); //=== typeof
//}
//console.log(users.filter(check));

const nameWitha = users.some((firstName) => {//users.firsName(take all object for the iteration)
  return firstName.firstName.includes("p");
});
console.log(nameWitha);

const numbers = [100,20,30,40,50];
const eve = numbers.some(num => num % 10==0);
